...
const constants = {
  ...
  NOTICE_TYPE_PROSPECT_WARNED_TO_BE_DEACTIVATED: 'notification_prospect_warned_to_be_deactivated',
  ...
  NOTICE_TYPE_TENANT_PROFILE_SHARING_REQUEST_ID: 68,
  NOTICE_TYPE_PROSPECT_WARNED_TO_BE_DEACTIVATED_ID: 69,
