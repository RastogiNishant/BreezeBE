...
const mapping = [
  [NOTICE_TYPE_LANDLORD_QUESTION_ID, NOTICE_TYPE_LANDLORD_QUESTION],
  ...
  [NOTICE_TYPE_LANDLORD_RECONFIRMED_ID, NOTICE_TYPE_LANDLORD_RECONFIRMED],
  [NOTICE_TYPE_LANDLORD_VISIT_STARTING_ID, NOTICE_TYPE_LANDLORD_VISIT_STARTING],
  [NOTICE_TYPE_LANDLORD_MATCH_ID, NOTICE_TYPE_LANDLORD_MATCH],
  [NOTICE_TYPE_LANDLORD_DECISION_ID, NOTICE_TYPE_LANDLORD_DECISION],
  [NOTICE_TYPE_PROSPECT_QUESTION_ID, NOTICE_TYPE_PROSPECT_QUESTION],
  [NOTICE_TYPE_PROSPECT_MENTION_ID, NOTICE_TYPE_PROSPECT_MENTION],
  ...
  [NOTICE_TYPE_CONFIRM_QUESTION_ID, NOTICE_TYPE_CONFIRM_QUESTION],
